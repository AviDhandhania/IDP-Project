...
| **E** | `IDP-HOLY-SHIT-IDEAS.md` | 12 from-scratch "holy shit you built that" builds, ranked on an awe-appropriate scheme |
...
**Section E is ranked separately, on purpose.** The 12 from-scratch builds there (own OS, own CPU, own database, own LLM) are chosen for *awe*, not novelty — they would all score ~2 on Pub and Patent, which would be noise rather than signal. They carry their own matrix (Awe / Feas / Demo / Depth / Cheap / Split / Risk⁻) in Section E. Three of them have a research seam that connects back to this table: **H3** → a paper of its own, **H7** → P18, **H8** → V1.
...
# Section E — IDP — "Holy Shit You Built That" Ideas

> *Reproduced in full from `IDP-HOLY-SHIT-IDEAS.md`. From-scratch builds chosen for impressiveness rather than novelty, with their own ranking scheme (Awe / Feas / Demo / Depth / Cheap / Split / Risk-).*
