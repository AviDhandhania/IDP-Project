...
// -------------------------------------------------------------
{
  const s = addSlideBase(pres, 27, 'Parameter 4 (3 M)', '7.5 INTERACTIVE WEB DASHBOARD', 'Full-Stack React Dashboard & REST API');
...
// -------------------------------------------------------------
{
  const s = addSlideBase(pres, 28, 'Parameter 4 (3 M)', '7.2 BENCHMARK DEMONSTRATION', 'Discriminating Call Sites on examples/sample_project');
...
// -------------------------------------------------------------
{
  const s = addSlideBase(pres, 29, 'Parameter 4 (3 M)', '7.3 ANALYSIS OF RESULTS', 'Empirical Proof of Discrimination & Noise Filtering');
...
// -------------------------------------------------------------
{
  const s = addSlideBase(pres, 30, 'Parameter 4 (3 M)', '7.4 CYCLONEDX 1.6 CBOM EXPORT', 'Machine-Readable Bill of Materials with Dataflow Extensions');
...
// -------------------------------------------------------------
{
  const s = addSlideBase(pres, 31, 'Parameter 4 (3 M)', '7.5 AUTOMATED TEST HARNESS', '100% Pass Rate on Unit Testing (tests/test_navigator.py)');
